      ...
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-border pb-4">
        <div>
          <div className="flex items-center gap-2.5">
            ...
            {unreadCount > 0 && (
              <span className="rounded-full bg-sky-700 px-2.5 py-0.5 text-xs font-extrabold text-white">
                ...
                <div className="space-y-3">
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex items-center gap-2">
                      <div
                          className={`h-9 w-9 rounded-full flex items-center justify-center font-bold text-xs shrink-0 ${!msg.read ? "bg-sky-700 text-white" : "bg-gray-100 text-gray-700"
                          }`}
                      >
                      ...
                      <div>
                        <h3 className="font-bold text-sm text-foreground flex items-center gap-2">
                          ...
                          {!msg.read && (
                            <span
                              className={`w-2 h-2 rounded-full animate-pulse ${isNewsletter ? "bg-blue-600" : "bg-sky-700"
                                }`}
                            />
                          )}
                        </h3>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-muted-foreground pt-1">
                    ...
                    {msg.email && (
                      <a
                        ...
                        className="flex items-center gap-1.5 hover:text-sky-700 transition-colors truncate"
                      >
          ...
          <div className="bg-card border border-border rounded-3xl p-6 max-w-lg w-full shadow-2xl space-y-5 dir-rtl">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-muted/40 p-3 rounded-xl space-y-1">
                  ...
                  <a
                    ...
                    dir="ltr"
                    className="font-bold text-sky-700 hover:underline block"
                  >
                ...
                <div className="bg-muted/40 p-3 rounded-xl space-y-1">
                  ...
                  <a
                    ...
                    dir="ltr"
                    className="font-bold text-sky-700 hover:underline truncate block"
                  >
            ...
            <div className="flex items-center justify-between pt-2 border-t border-border">
              <button
                ...
                className="px-4 py-2 rounded-xl bg-sky-50 text-sky-700 hover:bg-sky-100 text-xs font-bold transition-colors"
              >
                حذف الرسالة
              </button>
              ...
              <button
                onClick={() => setSelectedMessage(null)}
                className="px-5 py-2 rounded-xl bg-sky-600 text-white text-xs font-bold hover:bg-sky-700 transition-colors"
              >
                إغلاق
              </button>
            </div>
